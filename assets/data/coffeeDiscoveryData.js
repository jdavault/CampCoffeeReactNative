const discoverCoffeeData = [
  {
    ...
    description:
      "Arabica is the most popular type of coffee, hands down. Many coffee enthusiasts prefer using Arabica beans due to its taste. Typically used for black coffee, Arabica beans have a sweeter, more complex flavor that you can drink straight. While, it’s the most popular, it doesn’t have as much caffeine as Robusta.",
    liked: true,
    price: 50,
    rating: 5,
    shelfLife: 2,
